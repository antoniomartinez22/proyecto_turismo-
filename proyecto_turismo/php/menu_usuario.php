...
<body class="editar-usuario">
    ...
    <div class="content2">
        ...
        <h2 class="usuarios-registrados1">Usuarios Registrados</h2>
        <div class="menu-bienvenida">
            <a href="menu_usuario.php" class="registrar-admin1">Actualizar</a>
            ...
            <tbody>
                <?php foreach ($solicitudes as $solicitud) { ?>
                    <tr>
                        ...
                        <td><a href="<?php echo "editar_user.php?id=" . $solicitud->id ?>"><div class="edit-button"><img src="../images/editar-usuario.png" class="imagen-boton"></div></a></td>
                        <td><a href="<?php echo "eliminar_usuario.php?id=" . $solicitud->id ?>"><div class="delete-button"><img src="../images/eliminar-usuario.png" class="imagen-boton"></div></a></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
