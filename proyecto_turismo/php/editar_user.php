...
<div class="nav-bg">
    ...
    <div class="menu-bienvenida">
        <a href="menu_usuario.php" class="registrar-admin">Inicio</a>
        <a href="registro_usuario.html" class="registrar-admin" >Registrar Usuario</a>
    </div>
    <br><br>
    <div class="informacion">
    <div class="form-editar">
        <form action="actualizar_informacion_usuario.php" method="post" class="formulario-editar">
            <div class="id">
